            ...
            <li>
                ...
                <ul class="mt-2 text-sm text-gray-800">
                    <template x-for="thread in threads.threads">
                        <li class="cursor-default select-none px-4 py-2 hover:bg-purple-100" :id="`option-${thread.id}`"
            ...
            <li>
                ...
                <ul class="mt-2 text-sm text-gray-800">
                    <template x-for="article in articles.articles">
                        <li class="cursor-default select-none px-4 py-2 hover:bg-purple-100" :id="`option-${article.id}`"
                            role="option" tabindex="-1">
