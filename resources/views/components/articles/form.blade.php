    ...
    <div class="bg-gray-100 py-6 px-4 space-y-6 sm:p-6">
        <div>
            ...
            <x-forms.info class="px-0">
                Submit your article to the Laravel.io portal. Every article that gets approved will be shared with our 50.000 users and wil be tweeted out on our <a href="https://twitter.com/taskflowhr" class="text-lio-700 underline">Twitter account</a> which has over 45,000 followers. Feel free to submit as many articles as you like. You can even cross-reference an article on your blog with the original url.
            </x-forms.info>
