                    ...
                    <div>
                        <div class="flex items-center gap-x-4">
                            ...
                            @if ($user->isAdmin() || $user->isModerator())
                                <span class="border border-purple-600 text-purple-600 rounded px-3 py-1">
        ...
        <div class="mt-16 lg:mt-32" x-data="{ tab: 'threads' }">
            <div class="container mx-auto">
                <nav class="flex items-center justify-between lg:justify-start">
                    <button @click="tab = 'threads'" :class="{ 'text-purple-600 border-purple-600 border-b-2': tab === 'threads' }"  class="px-4 whitespace-nowrap py-5 font-medium text-lg text-gray-900 hover:text-purple-600 hover:border-purple-600 focus:outline-none focus:text-purple-600 focus:border-purple-600 lg:w-1/3">
                        Threads posted
                    </button>
                    <button @click="tab = 'replies'" :class="{ 'text-purple-600 border-purple-600 border-b-2': tab === 'replies' }"  class="px-4 whitespace-nowrap py-5 font-medium text-lg text-gray-900 hover:text-purple-600 hover:border-purple-600 focus:outline-none focus:text-purple-600 focus:border-purple-600 lg:w-1/3">
                        Replies posted
                    </button>
                </nav>
            </div>
